 ...
 */
contract ZimmerCoin is ERC20, Ownable {
    // Define the initial supply for ZCOIN (e.g., 1,000,000 ZCOIN with 18 decimals)
     ...
     */
    constructor() ERC20("ZimmerCoin", "ZCOIN") Ownable(msg.sender) {
